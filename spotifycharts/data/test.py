...
print(download(num_record=999999, frequency='weekly', start_date='2016-12-23--2016-12-30'))



# urllib.request.urlretrieve("https,//spotifycharts.com/regional/us/daily/latest/download": "test.csv")


# /regional/us/daily/latest/download